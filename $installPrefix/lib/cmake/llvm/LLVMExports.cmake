...
set_target_properties(LLVMSupport PROPERTIES
  INTERFACE_LINK_LIBRARIES "psapi;shell32;ole32;uuid;advapi32;ws2_32;\$<\$<NOT:\$<LINK_LANGUAGE:Swift>>:delayimp;-delayload:shell32.dll;-delayload:ole32.dll>;LLVMDemangle"
)
...
set_target_properties(LLVMCodeGen PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMAnalysis;LLVMBitReader;LLVMBitWriter;LLVMIRPrinter;LLVMCodeGenTypes;LLVMCore;LLVMMC;LLVMObjCARCOpts;LLVMProfileData;LLVMScalarOpts;LLVMSupport;LLVMTarget;LLVMTargetParser;LLVMTransformUtils"
)
...
set_target_properties(LLVMExtensions PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMSupport;Obfuscation"
)
...
# Create imported target Obfuscation
add_library(Obfuscation STATIC IMPORTED)
